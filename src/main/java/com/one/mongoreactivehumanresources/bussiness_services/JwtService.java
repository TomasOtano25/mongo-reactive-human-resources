...
import com.one.mongoreactivehumanresources.exceptions.JwtException;
...
public class JwtService {
    ...
    private static final String ISSUER = "com-one-human-resources-spring";
    private static final int EXPIRATION_IN_MILLISECOND = 3600000;
    ...
    public String createToken(String user, String name, String[] roles) {
        return JWT.create()
                ...
                .withExpiresAt(new Date(System.currentTimeMillis() + EXPIRATION_IN_MILLISECOND))
                .withClaim(USER, user)
                .withClaim(NAME, name)
